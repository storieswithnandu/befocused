...
import { Play, Pause, RotateCcw, Clock, Pencil, Save, X, Activity, Sparkles, Plus } from 'lucide-react';
            ...
            <div className="stats-panel">
                ...
                <div className="chart-container">
                    ...
                    <div className="chart-wrapper">
                        ...
                        {selectedDate && (
                            <div className="day-breakdown premium-breakdown">
                                <div className="day-breakdown-header">
                                    ...
                                    <button className="close-btn" onClick={() => setSelectedDate(null)} title="Close Details"><X size={16} /></button>
                                </div>
                                ...
                                <div className="breakdown-grid">
                                    <div className="breakdown-section">
                                        ...
                                        <div className="breakdown-cards">
                                            {sessions && sessions.filter(s => isSameDay(new Date(s.timestamp), selectedDate)).length > 0 ? (
                                                sessions.filter(s => isSameDay(new Date(s.timestamp), selectedDate)).map(s => (
                                                    <div key={s.id} className="breakdown-card">
                                                        ...
                                                        <div className="card-content">
                                                            ...
                                                            <span className="breakdown-meta">{Math.floor(s.duration / 60)} minutes • {format(new Date(s.timestamp), 'h:mm a')}</span>
                                                        </div>
                                                    </div>
                                                ))
                                            ) : (
                                    ...
                                    <div className="breakdown-section">
                                        ...
                                        <div className="breakdown-cards">
                                            {habits && habits.filter(h => h.completedDates.includes(format(selectedDate, 'yyyy-MM-dd'))).length > 0 ? (
                                                habits.filter(h => h.completedDates.includes(format(selectedDate, 'yyyy-MM-dd'))).map(h => (
                                                    <div key={h.id} className="breakdown-card">
                                                        <div className="card-indicator habit" style={{ backgroundColor: h.color }}></div>
                                                        <div className="card-content">
